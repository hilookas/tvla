...
def main():
    anno_path = "/home/chq/.cache/huggingface/hub/models--KarlP--droid/snapshots/bcb840c3b496533e0adf548a54b51f2f00057837"
    anno_cam2base_extrinsics, anno_cam2base_extrinsic_superset, anno_language_annotations = load_anno(anno_path)

    droid_base_path = "/mnt/20T/chq_large/droid_raw_1.0.1"
    output_path = "/mnt/20T/chq_large/tvla/droid"
    ...
    episodes = list_episodes(droid_base_path, success_only=False)

    for episode_meta_path in tqdm(episodes):
        try:
